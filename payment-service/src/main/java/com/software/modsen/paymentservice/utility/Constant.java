package com.software.modsen.paymentservice.utility;

public class Constant {
    public static final String CUSTOMER_NOT_FOUND_BY_ID = "Customer not found - %s";
    ...
    public static final String GET_CUSTOMER_BY_PASSENGER_ID = "Received customer by passenger id {}";
    public static final String CREATE_CUSTOMER = "Create customer for passenger {}";
    public static final String CHARGE_PASSENGER = "Charge passenger {} for {} {}";
    public static final String FINISH_RIDE = "Finish ride {}";
}
