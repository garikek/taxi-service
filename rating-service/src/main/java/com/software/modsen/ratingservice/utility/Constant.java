package com.software.modsen.ratingservice.utility;

public class Constant {
    public static final String PASSENGER_RATING_NOT_FOUND_BY_ID = "Passenger rating not found. id - %s";
    public static final String PASSENGER_RATING_NOT_FOUND_BY_PASSENGER_ID = "Passenger rating not found. passengerId - %s";
    public static final String DUPLICATE_PASSENGER_RATING = "Passenger id %s exists already";
    public static final String DRIVER_RATING_NOT_FOUND_BY_ID = "Driver rating not found - %s";
    public static final String DRIVER_RATING_NOT_FOUND_BY_DRIVER_ID = "Driver rating not found. driverId - %s";
    public static final String DUPLICATE_DRIVER_RATING = "Driver id %s exists already";
